...
**Version:** v1.0.0 — Production-Ready Reproducibility (10 helper scripts, 255 pytest cases, CI on Ubuntu + Windows × py3.11 + py3.13). See [CHANGELOG.md](./CHANGELOG.md) for the full release history.
