...
**Version:** v1.4.0 — two language versions, and no figure left unguarded. CI on Ubuntu + Windows × py3.11 + py3.13. See [CHANGELOG.md](./CHANGELOG.md) for the full release history.
