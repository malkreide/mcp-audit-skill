...
#: und liegt jetzt einmal in der Repo-Wurzel. Derselbe Grund wie bei den
#: zwoelf absorbierten Pruefungen — was dem Repository gehoert, gehoert nicht
#: der Suite.
REFERENCED_FILES = (
    f"{BASE}/SKILL.md",
    f"{BASE}/README.md",
...
@register(2, "referenced files exist", suite=SUITE)
