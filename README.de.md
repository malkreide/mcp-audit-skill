...
Das Feld ist optional; fehlt es, gilt `enforced`. Von 120 Checks sind genau fünfundzwanzig `advisory`: `ARCH-022`, `DRIFT-007`, `FID-006`, `FID-007`, `OBS-008`, `OPS-005`, `OPS-006`, `OPS-007`, `OPS-008`, `OPS-009`, `OPS-010` — dazu die vierzehn Migrations-Checks `ARCH-015`, `ARCH-016`, `ARCH-017`, `ARCH-018`, `ARCH-019`, `ARCH-020`, `ARCH-021`, `HITL-006`, `SCALE-008`, `SCALE-009`, `SCALE-010`, `SEC-025`, `SEC-026` und `SEC-027`. `DEP-001`, `DRIFT-006`, `OBS-007` und `ARCH-014` gingen denselben Weg und sind inzwischen auf `enforced` promoviert — die Brücke soll eine Handvoll neuer Checks tragen, nicht volllaufen.
