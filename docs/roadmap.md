...
Stand: **96 Checks in 12 Kategorien.** v0.5.0 ist vollständig gegen beide PDFs; die Kategorien `FID`, `IDENT`, `DRIFT` und `DEP` kamen danach aus Portfolio-Fundstücken hinzu (siehe CHANGELOG `[Unreleased]`).
