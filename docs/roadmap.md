...
Stand: **78 Checks in 10 Kategorien.** v0.5.0 ist vollständig gegen beide PDFs; die Kategorien `FID` und `IDENT` kamen danach aus Portfolio-Fundstücken hinzu (siehe CHANGELOG `[Unreleased]`).
