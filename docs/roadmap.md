...
Stand: **112 Checks in 12 Kategorien**, auf zwei Spec-Baselines (`2025-11-25` und `2026-07-28`). v0.5.0 ist vollständig gegen beide PDFs; die Kategorien `FID`, `IDENT`, `DRIFT` und `DEP` kamen danach aus Portfolio-Fundstücken hinzu, die vierzehn Migrations-Checks mit v2.0.0 aus dem Spec-Changelog 2026-07-28 (siehe CHANGELOG).
